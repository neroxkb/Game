...
using System.Text;
public class ConnectingManager : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks, ILobbyCallbacks
{
    ...
    public void ConnectInternationServer()
    {
        ...
        PhotonNetwork.PhotonServerSettings.AppSettings.AppIdRealtime = "f570b874-8abf-4359-8d30-1ffa09c55e53"; // TODO: replace with your own AppId
        PhotonNetwork.NetworkingClient.AppId = PhotonNetwork.PhotonServerSettings.AppSettings.AppIdRealtime;
        PhotonNetwork.NetworkingClient.NameServerHost = "ns.photonengine.com";
    ...
    public void ConnectingUpdate()
    {
        ...
        ConnectingStatus.text = PhotonNetwork.NetworkClientState.ToString();
        if (ConnectingStatus.text.Equals("ConnectedToNameServer"))
        {
